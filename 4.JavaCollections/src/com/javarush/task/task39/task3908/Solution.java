...
public class Solution {
    public static void main(String[] args) {
        System.out.println(isPalindromePermutation("Aabaa"));
        System.out.println(isPalindromePermutation("babggaaajjajajaa "));
        System.out.println(isPalindromePermutation("baba"));
    }
